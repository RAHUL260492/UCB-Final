...
const staticPages = [
    ...
    { _type: 'page', title: 'Corporate and Non-Profit Training', slug: '/training', description: 'Customized corporate and non-profit training programs.' },
...
const staticPrograms = [
    { _type: 'program', title: "Early Childhood Education Associate Degree", slug: "early-childhood-education", description: "Turn your love for children into a rewarding career. Start working after completing ECE104—earn while you learn! Become a childcare center director, preschool teacher, or start your own childcare business.", tagline: "Associate Degree | 61 credits | English, Spanish & Mandarin" },
    ...
    { _type: 'program', title: "Case Management Certificate", slug: "case-management", description: "Master the skills to support individuals and families navigating life's challenges. Become a case manager, social services assistant, or behavioral case worker.", tagline: "Certificate | 21 credits | English" },
    { _type: 'program', title: "Children's Behavioral Health Certificate", slug: "childrens-behavioral-health-certificate", description: "Prepare for Registered Behavior Technician (RBT®) certification and Community Health Worker credentials. Support children with special needs and their families with skill and compassion.", tagline: "Certificate | 16 credits | English & Spanish" },
    ...
    { _type: 'program', title: "Foundations of Early Childhood Education Certificate", slug: "early-childhood-education-certificate", description: "Turn your love for children into a career. This certificate meets the Massachusetts Department of Early Education and Care requirements for a lead teacher credential. Become a preschool teacher, childcare worker, or start your own family childcare business.", tagline: "Certificate | 16 credits | English, Spanish & Mandarin" },
    { _type: 'program', title: "Elder Care Certificate", slug: "elder-care", description: "Enter Massachusetts' fastest-growing field. Earn Community Health Worker Certification and support older adults and their families.", tagline: "Certificate | 21 credits | English & Spanish" },
