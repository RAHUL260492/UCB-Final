            ...
            <section className="py-12 bg-gray-50 border-y border-gray-100">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Mission */}
                        <ScrollAnimation variant="fade-up" delay="0.1s" className="flex">
                            <div className="bg-white p-8 rounded-3xl shadow-sm border-l-8 border-ucb-blue flex flex-col justify-between hover:shadow-md transition-shadow w-full">
                                <div>
                        ...
                        {/* Vision */}
                        <ScrollAnimation variant="fade-up" delay="0.2s" className="flex">
                            <div className="bg-white p-8 rounded-3xl shadow-sm border-l-8 border-ucb-orange flex flex-col justify-between hover:shadow-md transition-shadow w-full">
                                <div>
            ...
            <section className="py-16 bg-gray-50 border-y border-gray-100">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {stats.map((item, idx) => (
                            <ScrollAnimation key={idx} variant="fade-up" delay={`${(idx % 3) * 0.1}s`} className="flex">
                                <div className="bg-white p-6 rounded-3xl border border-gray-100/80 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between w-full">
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-7">
                            <ScrollAnimation variant="fade-up" delay="0.2s">
                                <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 animate-slide-in">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {diffFeatures.map((item, idx) => (
                            <ScrollAnimation key={idx} variant="fade-up" delay={`${(idx % 2) * 0.1}s`} className="flex">
                                <div className="bg-white p-6 rounded-3xl border border-gray-100 flex gap-4 hover:shadow-md transition-shadow w-full">
                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {supportServices.map((service, idx) => (
                            <ScrollAnimation key={idx} variant="fade-up" delay={`${(idx % 4) * 0.08}s`} className="flex">
                                <div className="bg-white p-5 rounded-2xl border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow w-full">
            ...
            <section className="py-16 bg-gradient-to-r from-ucb-blue to-blue-950 text-white relative overflow-hidden">
                <div className="container mx-auto px-6 max-w-5xl relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        {/* Partner CTA */}
                        <ScrollAnimation variant="fade-up" delay="0.1s">
