...
const PROGRAMS: Program[] = [
  ...
  { id: '8', title: 'Case Management', type: 'Certificate', tags: ['English', '9 Months'], description: 'Make a difference with specialized case management skills.', link: '/programs/case-management-certificate' },
  ...
  { id: '12', title: 'Early Childhood Education', type: 'Certificate', tags: ['English, Spanish & Mandarin', '1 Year'], description: 'Begin your journey in early childhood education.', link: '/programs/foundations-early-childhood-education-certificate' },
  { id: '11', title: 'Elder Care', type: 'Certificate', tags: ['English & Spanish', '1 Year'], description: 'Transform lives while building your own career. Master the skills that help older adults and their families thrive.', link: '/programs/elder-care-certificate' },
  ...
  { id: '1', title: 'Early Childhood Education', type: 'Associate Degree', tags: ['English, Spanish & Mandarin', '2 Years'], description: 'Prepare for a career nurturing the next generation.', link: '/programs/early-childhood-education-associate-degree' },
  { id: '3', title: 'General Studies', type: 'Associate Degree', tags: ['English', '2 Years'], description: 'Build a solid foundation for your bachelor\'s degree.', link: '/programs/general-studies-associate-degree' },
  { id: '2', title: 'Human Services Administration', type: 'Associate Degree', tags: ['English & Spanish', '2 Years'], description: 'Do you want to help people? Make a real difference in your community while building the skills and credentials for a rewarding career in social services.', link: '/programs/human-services-administration-associate-degree' },
];
